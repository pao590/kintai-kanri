...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-center align-items-center mb-4">
        <a href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => \Carbon\Carbon::parse($month)->subMonth()->format('Y-m')]) }}"
            class="btn btn-link">&larr; 前月</a>
        ...
        <a href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => \Carbon\Carbon::parse($month)->addMonth()->format('Y-m')]) }}"
            class="btn btn-link">翌月 &rarr;</a>
    </div>
    ...
    <table class="table table-bordered text-center align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if ($day)
                    <a href="{{ route('admin.attendance.show', $day->id) }}" class="btn btn-sm btn-outline-primary">詳細</a>
                    @else
                    -
                    @endif
                </td>
    ...
    <div class="text-start mt-4">
        <a href="#" class="btn btn-outline-success">CSV出力</a>
    </div>
